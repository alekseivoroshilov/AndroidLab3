...
class Act2 : Menu() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.button2r).setOnClickListener {
            startActivity(Intent(this, Act1::class.java).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP))
        }
        findViewById<Button>(R.id.button3r).setOnClickListener {
            startActivity(Intent(this, Act3::class.java).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP))
        }
    }
